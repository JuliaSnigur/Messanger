...
#include "../../../../src/SecureServerLib/mythread.h"
...
QT_MOC_LITERAL(6, 66, 14) // "slotDisconnect"

    },
    "MyThread\0error\0\0QAbstractSocket::SocketError\0"
    "errors\0slotReadyRead\0slotDisconnect"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->error((*reinterpret_cast< const QAbstractSocket::SocketError(*)>(_a[1]))); break;
        ...
        {
            typedef void (MyThread::*_t)(const QAbstractSocket::SocketError & );
...
// SIGNAL 0
void MyThread::error(const QAbstractSocket::SocketError & _t1)
{
